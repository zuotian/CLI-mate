...
from flask.ext.wtf import (Form, FileField, SubmitField, FieldList, FormField, PasswordField, TextField)
...
class RegistrationForm(UserFormBase):
    password = PasswordField(validators=[Required()])
    repeat_password = PasswordField(validators=[Required()])
